package com.bades.atm.data;



import com.bades.atm.logic.Amount;
import com.bades.atm.logic.User;
...
public class writerAndReader {
    ...
    public void writeHeadersInFile() {
        try {
            ...
            fileWriter = new FileWriter("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\users.csv", true);
    ...
    public void writeAtmHeadersInFile() {
        try {
            FileWriter fileWriter = null;
            fileWriter = new FileWriter("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\atm_data.csv", true);
            BufferedWriter bufferedWriter= new BufferedWriter(fileWriter);
    ...
    public void writeUserIntoFile(User i) {
        try {
            FileWriter fileWriter =
                    new FileWriter("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\users.csv", true);
            BufferedWriter bufferedWriter= new BufferedWriter(fileWriter);
    ...
    public void writeAtmDataIntoFile(Amount i) {
        try {
            FileWriter fileWriter =
                    new FileWriter("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\atm_data.csv", true);
            BufferedWriter bufferedWriter= new BufferedWriter(fileWriter);
    ...
    public void readUsersFromFile(Vector<User> users) {
        ...
        try {
            FileInputStream fileStream = new FileInputStream("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\users.csv");
    ...
    public Amount readAtmData() {
        ...
        try {
            FileInputStream fileStream = new FileInputStream("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\atm_data.csv");
            DataInputStream dataStream = new DataInputStream(fileStream);
            BufferedReader bufferReader = new BufferedReader(new InputStreamReader(dataStream));
            while ((value = bufferReader.read()) != -1) {
                char character = (char) value;
