...
import com.bades.atm.data.writerAndReader;
...
public class ATM {
    ...
    private ATM() {
        ...
        try {
            File myObj = new File("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\users.csv");
        ...
        try {
            File myObj = new File("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\atm_data.csv");
            if (!myObj.createNewFile()) {   //if file has already created
    ...
    public Amount withdrawMoney(String accNo, int money) {
        ...
        readAndWrite.truncateAFile("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\users.csv");
        readAndWrite.writeHeadersInFile();
        for (User user : users) {
            readAndWrite.writeUserIntoFile(user);
        }

        readAndWrite.truncateAFile("C:\\Users\\bades\\AtmApp\\src\\com\\bades\\atm\\data\\atm_data.csv");
        readAndWrite.writeAtmHeadersInFile();
